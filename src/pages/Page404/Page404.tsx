      ...
      <div className={styles.page404Container}>
        <div className={styles.content}>
          ...
          <div className={styles.buttonsContainer}>
            <Link
              to="https://www.figma.com/proto/fRbb7YQ8bAlEppiRjWYacP/All-Designs?type=design&node-id=3-34368&t=FHdSikjoIgCOTjj5-0&scaling=scale-down-width&page-id=3%3A32415"
              target="_blank"
